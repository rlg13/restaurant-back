...
-- Example VALUES FOR LOCAL testing.
INSERT INTO ORDERS (USER_ID, DAY_ORDER,STATE, FIRST_DISH_ID,SECOND_DISH_ID,DESERT_ID, DAY_TO_SERVE ) VALUES (1,SYSDATE-2,'RECEIVED',1,4,7,SYSDATE-1);
INSERT INTO ORDERS (USER_ID, DAY_ORDER,STATE, FIRST_DISH_ID,SECOND_DISH_ID,DESERT_ID, DAY_TO_SERVE ) VALUES (1,SYSDATE-1,'RECEIVED',1,4,7,SYSDATE);
INSERT INTO ORDERS (USER_ID, DAY_ORDER,STATE, FIRST_DISH_ID,SECOND_DISH_ID,DESERT_ID, DAY_TO_SERVE ) VALUES (1,SYSDATE-1,'DELIVERED',1,4,7,SYSDATE);
INSERT INTO ORDERS (USER_ID, DAY_ORDER,STATE, FIRST_DISH_ID,SECOND_DISH_ID,DESERT_ID, DAY_TO_SERVE ) VALUES (1,SYSDATE-1,'RECEIVED',1,4,7,SYSDATE);
INSERT INTO ORDERS (USER_ID, DAY_ORDER,STATE, FIRST_DISH_ID,SECOND_DISH_ID,DESERT_ID, DAY_TO_SERVE ) VALUES (1,SYSDATE-1,'RECEIVED',1,4,7,SYSDATE);
INSERT INTO ORDERS (USER_ID, DAY_ORDER,STATE, FIRST_DISH_ID,SECOND_DISH_ID,DESERT_ID, DAY_TO_SERVE ) VALUES (1,SYSDATE-1,'RECEIVED',1,4,7,SYSDATE);
INSERT INTO ORDERS (USER_ID, DAY_ORDER,STATE, FIRST_DISH_ID,SECOND_DISH_ID,DESERT_ID, DAY_TO_SERVE ) VALUES (1,SYSDATE-1,'RECEIVED',1,4,7,SYSDATE);
